...
public class ScriptS3270 {
	...
	public static void main(String[] args) {
		...
		System.out.println(session.connect("192.168.15.20", "23", true));
...
//		System.out.println(session.asciiScreen());
		...
		JOptionPane.showMessageDialog(null, "Script S3270 finalizado. Verifique o console para os resultados.");
